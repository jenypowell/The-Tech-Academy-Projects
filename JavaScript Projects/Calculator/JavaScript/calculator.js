...
const Calculator =  {
    ...
    //this will hold the operator, we seit it to null for now
    operator: null,
};

//this midifies values each time a button is clicked
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true)   {
        ...
        //otherwiese it ad onto it
        Calculator.Display_Value = Display_Value === '0' ? digit : Display_Value + digit;
    }
}
//this section handles decimal points
function Input_Deicmal(dot) {
...
function Handle_Operators(Next_Operator)    {
    ...
    //when an operator key is pressed we want to convert the current number
    ...
    //then updates the operator and ezits from the funtion
    ...
    if (First_Operand == null)  {
        ...
        //here we add a fized amount of numers after the decimal
    ...
    keys.addEventListener('click', (event) =>   {
        ...
        //that was clicked
        const { target } = event;
        //if the element that was clicked in is not a button, exit the function
